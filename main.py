...
from routes.trainers import (
    trainers_auth,
    trainers_connections,
    trainers,
    trainers_products,
    trainers_meals_for_users,
    trainers_exercises,
    trainers_training_plans_for_users,
    trainers_workout_logs_by_users
    )
...
app.include_router(trainers_training_plans_for_users.router, prefix="/trainer/training-plans", tags=["Trainer: training plans for users"])
app.include_router(trainers_workout_logs_by_users.router, prefix="/trainer/workout-log", tags=["Trainer: workout logs by users"])
...
app.include_router(users_training_plans.router, prefix="/user/training-plans", tags=["User: training plans"])
app.include_router(users_workout_log.router, prefix="/user/workout-log", tags=["User: workout logs"])